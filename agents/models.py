...
class ResortStatus(BaseModel): 
    ...
    resort_name: str = Field(..., description="The name of the resort")
    resort_status: Literal["open", "closed"] = Field(..., description="Whether the resort is currentlyopen or closed")
    ...
    lifts_total: int = Field(..., description="The total number of lifts at the resort")
    runs_open: int = Field(..., description="The number of runs that are currently open")
    runs_total: int = Field(..., description="The total number of runs at the resort")
